...
if paneSet.child_window(title="P_WarRoom", auto_id="rtbP_WarRoom", control_type="RadioButton").exists(timeout = 3):
    pass
# print(app2.window(title ='Form1',class_name_re="WindowsForms10").print_control_identifiers())
paneSet.child_window(title="P_WarRoom", auto_id="rtbP_WarRoom", control_type="RadioButton").click()
...
app2.window(title ='Form1').child_window(auto_id="WbsMain", control_type="Pane").capture_as_image().save(r'../picture/DTP_WarRoom.png')
