...
if paneSet.child_window(title="P_WarRoom", auto_id="rbtP_WarRoom", control_type="RadioButton").exists(timeout = 3):
    pass

paneSet.child_window(title="P_WarRoom", auto_id="rbtP_WarRoom", control_type="RadioButton").click()
...
app2.window(title ='Form1').child_window(auto_id="WbsMain", control_type="Pane").capture_as_image().save(r'../picture/SVRP_WarRoom.png')
